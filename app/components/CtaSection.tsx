    ...
    <>
      <section id="cta" aria-label="Call to action" className="relative bg-obsidian px-8 md:px-16 py-36 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <p className="font-sans font-light text-body-base text-text-secondary leading-[1.82] mb-12">It is for the rare few who understand that what they know and how they think is a legacy, and that leaving it uncaptured is a choice their family will feel for generations.</p>
          <div className="flex items-center justify-center gap-5 flex-wrap">
            <a href="/apply" className="btn-monolith-amber group">Request Your Founding <span className="transition-transform duration-200 group-hover:translate-x-1">→</span></a>
          </div>
