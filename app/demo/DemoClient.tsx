  ...
  return (
    <div
      style={{
        ...
        zIndex:     60,
        overflowY:  'auto',
        background: `radial-gradient(120% 90% at 50% 0%, var(--invert-raise) 0%, ${C.void} 60%)`,
        color:      C.text,
      }}
    >
      <style>{`
      ...
      {/* Exit affordance */}
      {/* Was the Guide dashboard until September 20, 2026. This demo is public now,
          so the way out is the homepage. */}
      <Link
        href="/"
        style={{
          position:      'fixed',
              ...
              {Array.from({ length: TOTAL_Q }).map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    height:       '3px',
                    borderRadius: '2px',
                    background:   i < qIndex ? C.gold : 'var(--invert-field)',
                    boxShadow:    i === qIndex ? '0 0 8px var(--invert-gold)' : 'none',
                  ...
                  {FOLLOW_UPS.map((f, i) => (
                    <button
                      ...
                      style={{
                        ...
                        border:        `1px solid ${used.has(i) ? 'var(--invert-rule)' : 'var(--invert-gold-line)'}`,
                        borderRadius:  '999px',
        ...
        <Stage>
          ...
          <div
            style={{
              width:       '100%',
              maxWidth:    '680px',
              borderLeft:  '2px solid var(--invert-gold)',
              background:  'var(--invert-field)',
        ...
        <Stage>
          ...
          {showPaper && paperState !== 'sent' && (
            <div className="demo-fade" style={{ marginTop: '2.25rem', width: '100%', maxWidth: '460px' }}>
              ...
              {paperState === 'error' && (
                <p style={{ fontFamily: SERIF, fontStyle: 'italic', fontSize: '0.9rem', color: 'var(--invert-error)', marginTop: '0.75rem' }}>
                  {paperError}
                </p>
              )}
            </div>
          ...
          {paperState === 'sent' && (
            <p className="demo-fade" style={{ fontFamily: SERIF, fontStyle: 'italic', fontSize: '1.1rem', color: 'var(--invert-gold)', marginTop: '2.25rem' }}>
    ...
    <label style={{ display: 'block' }}>
      ...
      <input
        ...
        style={{
          ...
          background:   'transparent',
          border:       'none',
          borderBottom: '1px solid var(--invert-gold-line)',
          color:        C.text,
          fontFamily:   SERIF,
          fontSize:     '1.35rem',
          fontWeight:   300,
...
function ScoreReadout({ score, dimension }: { score: number; dimension: string }) {
  const color = score >= 70 ? C.gold : score >= 45 ? C.muted : C.dim
  return (
