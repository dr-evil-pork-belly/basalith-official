    ...
    <>
      ...
      <main>
          ...
          >
            ...
            <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-16 items-start">
              ...
              <div className="lg:sticky lg:top-32 flex flex-col gap-4">
                ...
                <div>
                  <p className="eyebrow mb-2">Tenet {num}</p>
              ...
              <div className="flex flex-col gap-0">
                ...
                <div className="flex flex-col gap-6">
                  {body.map((para, j) => (
                    <p key={j} className="font-sans font-light text-body-base text-text-secondary leading-[1.9]" style={{ whiteSpace: 'pre-line' }}>
                      {para}
                    </p>
                  ))}
                </div>
        ...
        <section
          ...
          aria-label="Data ownership closing"
        >
          <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-border-amber to-transparent" />
          <div
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            >
              &ldquo;We did not build a platform with a privacy policy.
              We built an institution with a constitution.&rdquo;
            </p>
