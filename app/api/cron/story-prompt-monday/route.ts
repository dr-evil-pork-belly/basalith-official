...
<body style="background:#0A0908;font-family:Georgia,serif;color:#F0EDE6;max-width:600px;margin:0 auto;padding:0">
  <div style="padding:32px 32px 0">
    ...
    <p style="font-family:'Courier New',monospace;font-size:11px;letter-spacing:2px;color:#8B9196;margin:0">A MEMORY FOR THE RECORD</p>
  </div>
  <div style="padding:32px">
    ...
    <p style="font-family:Georgia,serif;font-size:15px;font-style:italic;color:#A29B90;line-height:1.7;margin:0 0 28px;text-align:center">${ui.replyNote}</p>
...
<body style="background:#0A0908;font-family:Georgia,serif;color:#F0EDE6;max-width:600px;margin:0 auto;padding:0">
  <div style="padding:32px 32px 0">
    ...
    <p style="font-family:'Courier New',monospace;font-size:11px;letter-spacing:2px;color:#8B9196;margin:0">MONDAY MYSTERY · ${dateStr}</p>
  </div>
  <div style="padding:24px 32px 0">
    ...
    <p style="font-family:Georgia,serif;font-size:16px;font-style:italic;color:#A29B90;margin:0 0 24px">Nobody has labeled it yet.${eraEstimate ? ` Our AI thinks it is from ${eraEstimate}.` : ''}</p>
  </div>
