    ...
    try {
      ...
      for (const date of matching) {
        ...
        try {
          ...
          console.warn('[anniversary-triggers] reply session failed:', e instanceof Error ? e.message : e)
        }

        console.log('[anniversary-triggers] sending to:', archive.owner_email, 'replyTo:', replyTo)
