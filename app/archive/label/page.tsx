...
type ArchiveItem = {
  id:          string
  title:       string        // auto-derived, used by gallery/dashboard
  story:       string        // WHAT WAS HAPPENING (field 1)
  essence:     string        // WHAT SHOULD THEY KNOW (field 2)
  people:      string        // WHO IS IN THIS PHOTOGRAPH (field 3)
  year:        number | ''   // WHEN (field 4)
  season:      string        // part of WHEN
  decade:      string        // derived from year
  location:    string        // WHERE (field 5)
  inviteEmail: string        // WHO ELSE WOULD REMEMBER (field 6)
  contributor: string
  imageData?:  string
  labeledAt:   string
}
...
function MilestoneOverlay({ count, onDone }: { count: number; onDone: () => void }) {
  ...
  const texts = MILESTONE_TEXTS[count] ?? {
    main: `${count} memories preserved.`,
    sub:  'THE ARCHIVE GROWS',
  }
  ...
  return (
    <div
      ...
      style={{
        ...
        animation:   exiting
          ? 'milestoneOut 0.6s ease forwards'
          : 'milestoneGhostIn 0.4s ease forwards',
      ...
      {showGhost && (
        <p
          ...
          style={{
            ...
            lineHeight:    1,
            userSelect:    'none',
            animation:     'milestoneGhostIn 0.5s ease forwards',
          }}
        >
          {count}
        </p>
        ...
        {showMain && (
          <p
            style={{
              ...
              lineHeight:   1.3,
              whiteSpace:   'pre-line',
              animation:    'milestoneMainIn 0.6s cubic-bezier(0.16,1,0.3,1) forwards',
            }}
          >
            {texts.main}
          </p>
        ...
        {showSub && (
          <p
            style={{
              ...
              animation:     'milestoneSubIn 0.4s ease forwards',
            }}
          >
            {texts.sub}
          </p>
...
export default function LabelPage() {
  ...
  // Fire overlay after success card appears
  useEffect(() => {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Auto-derive title for gallery/dashboard display
    const titleParts = [
  ...
  // ── TEST: fires milestone overlay with a random milestone ──
    ...
    return (
      <>
        ...
        <div className="max-w-lg mx-auto pt-12">
          ...
          >
            <p style={{ fontFamily: 'monospace', fontSize: '0.52rem', letterSpacing: '0.14em', color: '#5C6166', textTransform: 'uppercase', marginBottom: '1rem' }}>
              Archive Depth
            </p>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                ...
                style={{ fontFamily: 'monospace', fontSize: '0.62rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#5C6166' }}
              >
                View Gallery →
              </a>
            </div>
  ...
  return (
    <>
      {/* Milestone overlay — can fire from test button */}
      {showOverlay && milestoneCount !== null && (
        <MilestoneOverlay count={milestoneCount} onDone={() => setShowOverlay(false)} />
      )}
      ...
      <div className="max-w-2xl mx-auto">
        ...
        {/* Streak bar */}
        <div
          className="flex items-center gap-6 mb-10 px-5 py-4 rounded-sm border"
          style={{ background: '#111112', borderColor: 'rgba(255,255,255,0.06)' }}
        >
          <div>
            <p style={{ fontFamily: 'monospace', fontSize: '0.5rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: '#5C6166', marginBottom: '0.25rem' }}>
              Streak
            </p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-10">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <p
                ...
                style={{ fontFamily: 'monospace', fontSize: '0.4rem', color: '#3A3F44' }}
              >
          ...
          {/* ── FIELD 2: WHAT SHOULD THEY KNOW ──────────────────────── */}
          <div>
            <label style={monoLabel}>What Should They Know</label>
            <textarea
              rows={5}
              value={form.essence}
              onChange={setField('essence')}
            ...
            <p
              ...
              style={{ fontSize: '0.78rem', fontStyle: 'italic', color: 'rgba(196,162,74,0.55)', marginTop: '0.5rem' }}
            >
              This field trains the Ancestor AI.
            </p>
          </div>

          {/* ── FIELD 3: WHO IS IN THIS PHOTOGRAPH ───────────────────── */}
          <div>
            ...
            <input
              ...
              className="focus:outline-none placeholder:text-[#3A3F44]"
              style={{ ...baseInput, paddingBottom: '0.5rem' }}
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                style={{ ...baseInput, paddingBottom: '0.5rem', cursor: 'pointer' }}
              >
        ...
        <div className="mt-8 pt-6 border-t" style={{ borderColor: 'rgba(255,255,255,0.04)' }}>
          <button
            ...
            className="w-full py-2 rounded-sm border transition-colors duration-200"
