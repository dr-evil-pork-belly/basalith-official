        ...
        <div className="rounded-sm border border-border-subtle p-8" style={{ background: '#111112' }}>
          <div className="flex flex-col gap-6">
            {[
              ...
              { step: '05', title: 'Founding Essence Session',  desc: 'The first live labelling session — 90 minutes. This is where it becomes real. A Senior Archivist guides the family.' },
