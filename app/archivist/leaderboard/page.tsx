              ...
              <tbody>
                {sorted.map((row, i) => {
                  ...
                  return (
                    <tr
                      key={row.id}
                      style={i < sorted.length - 1 ? { borderBottom: '1px solid rgba(255,255,255,0.06)' } : {}}
                    >
                      ...
                      <td className="px-5 py-4">
                        <p
                          ...
                          style={{ color: isMe ? '#C4A24A' : '#F0F0EE' }}
                        >
                          {row.name}{isMe ? ' ·' : ''}
                          {isMe && <span className="font-sans text-[0.62rem] ml-1 font-normal" style={{ color: '#C4A24A' }}>you</span>}
                        </p>
                  ...
                  return (
                    ...
                    >
                      <td className="px-5 py-3 font-sans text-[0.8rem]" style={{ color: isMe ? '#C4A24A' : '#F0F0EE' }}>
                        {row.name}{isMe ? <span className="font-sans text-[0.62rem] ml-1" style={{ color: '#5C6166' }}>(you)</span> : null}
                      </td>
                      <td className="px-5 py-3 font-serif font-semibold" style={{ fontSize: '1rem', color: '#F0F0EE', letterSpacing: '-0.02em' }}>{sc}</td>
                      <td className="px-5 py-3 font-sans text-[0.78rem]" style={{ color: bonusTier !== '—' ? '#C4A24A' : '#3A3F44' }}>
                        {bonusTier}
                      </td>
                    </tr>
                  )
