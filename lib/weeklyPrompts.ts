...
export const WEEKLY_PROMPTS_ZH: Record<string, string[]> = {
  professional_philosophy: [
    '回想一下您做过的最艰难的职业决定。不是最重要的，而是最艰难的。是什么决定，您是如何处理的？',
    '您对努力工作的看法与周围大多数人有什么不同？',
    '您学到的关于建立事业最重要的一课是什么？',
    '描述一次您为了诚信而放弃机会的时刻。发生了什么，您后悔吗？',
  ],
  relationship_to_family: [
    '您家中哪位成员对您影响最深？他们如何改变了您看世界的方式？',
    '有什么事情是您的子女现在还不理解，但您希望他们将来能明白的？',
    '描述一个您感到最为家人骄傲的时刻。发生了什么？',
    '您希望您的孙子辈了解您是如何爱您的家人的？',
  ],
  core_values: [
    '描述一次您的价值观让您付出了真实代价的时刻。您会再做同样的选择吗？',
    '您从未越过的那条线是什么——不是因为有人告诉您不要，而是因为您内心不允许？',
    '如果您能给孙子辈留下一个信念，那会是什么？',
    '诚信对您来说在实践中意味着什么——不是概念，而是每天的决定？',
  ],
  approach_to_money: [
    '钱第一次对您来说感觉真实是什么时候——不是抽象的，而是有实际分量的东西？',
    '哪次财务错误教会了您最多？请具体说说。',
    '您会告诉孙子辈关于金钱的什么——大多数人永远想不明白的那些道理？',
    '什么是您花了几十年才明白的关于财富的道理？',
  ],
  approach_to_people: [
    '您如何快速判断一个人是否值得信任？您寻找什么？',
    '描述一个改变了您对人看法的人。他们教会了您什么？',
    '您最了解但周围的人似乎总在经历的关于人的道理是什么？',
    '忠诚对您意味着什么，这个定义从何而来？',
  ],
  defining_experiences: [
    '什么是改变了您人生方向的那个经历？',
    '描述您人生中最艰难的时期的具体细节。是什么帮您度过了那段时光？',
    '您从事过什么冒险——大多数处在您位置的人不会去冒的险？',
    '您希望可以给您的孩子一种经历，而不用让他们去受苦？',
  ],
  wisdom_and_lessons: [
    '您学到的最有价值的一件事是什么——那个在生活每个领域都给了您最大助力的洞见？',
    '您现在知道的，希望25岁时就有人告诉您的是什么？',
    '什么是现在看起来显而易见，但花了您最长时间才学会的事？',
    '您给别人的建议，当您年轻时自己却没有遵循的是什么？',
  ],
  early_life: [
    '描述您成长的地方——不是事实，而是感受。您童年世界的质感是什么？',
    '在您早年生活中，直系家庭以外最重要的人是谁？',
    '您童年的自己会怎么看待您现在成为的人？',
    '您小时候最早的记忆是什么，它告诉了您什么关于那时的您？',
  ],
  inner_life: [
    '在一个完全独处的下午，没有任何待办事项，您会怎么度过？',
    '您身上有什么秘密的美德——一种您不常展示但确实拥有的品质？',
    '当一切感觉毫无意义时，您如何找回意义？',
    '什么给了您平静？不是幸福，而是平静？',
  ],
  mortality_and_legacy: [
    '当您想到自己的人生将会如何被记住时，您真正希望的是什么？',
    '您想让孙子辈在想到您时感受到什么？',
    '有什么您绝对不想带进坟墓的遗憾？',
    '如果您只有一年的时间，您会立刻停止做什么，又会开始做什么？',
  ],
}

export function getWeeklyPromptZh(dimension: string, weekNumber: number): string {
  const prompts = WEEKLY_PROMPTS_ZH[dimension] ?? WEEKLY_PROMPTS_ZH.wisdom_and_lessons
